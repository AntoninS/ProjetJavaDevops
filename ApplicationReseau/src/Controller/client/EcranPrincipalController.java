...
public class EcranPrincipalController implements Initializable {
    // le client qui reçoit les données
    private Client client;
    // Un message json pour les messages à afficher a l'écran
    private JSONObject messageJSON;

    //Liste des chevaux du podium
    ...
    public void arretServeur(int dureeAvantArret) {
        Platform.runLater(
                () -> {
